...
class KegiatanController extends Controller
{
    ...
    {
        $response = Kegiatan::select('thn_anggaran as id', 'thn_anggaran as text')
    ...
    {
        $data = Kegiatan::with(['toDinas'])->get();
    ...
    public function save(Request $request)
    {
        try {
            ...
            $kegiatan->id_dinas      = $request->id_dinas;
