...
class LaporanController extends Controller
{
    ...
    public function kegiatan_print_filter(Request $request)
    {
        ...
        if ($request->id_dinas) {
            $query->where('kegiatan.id_dinas', '=', $request->id_dinas);
        }
        if ($request->tahun) {
    ...
    public function kegiatan_print_all(Request $request)
    {
        ...
        if ($request->q_id_dinas) {
            $qry_dinas->where('dinas.id_dinas', '=', $request->q_id_dinas);
        }
        $dinas = $qry_dinas->get();
        ...
        $data = [
            'title'      => 'Kegiatan',
            'dinas'      => 'BADAN PENGELOLAAN KEUANGAN DAERAH',
            'data'       => $result,
            'ttd'        => $ttd,
